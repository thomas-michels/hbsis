...
cliente = Cliente("Ted", 18, 3333)
cliente.adicionarSaldo(255)
print(f'Saldo: R$ {cliente.verificarSaldo()}')
valor = (cliente.descontarSaldo("cerveja_ipa", 30000000))
print(f'Valor: R$ {round(valor[0], 2)} - Quantidade: {valor[1]} ml')