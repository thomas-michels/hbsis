...
from gerenciadorLista import lista_simples_inpura_int_str
from gerenciadorLista import lista_simples_int
from gerenciadorLista import lista_simples_str
from gerenciadorLista import lista_simples_impura
from gerenciadorLista import embaralhar
from gerenciadorLista import embaralhar_int_str_hard
from gerenciadorLista import binario
import copy
...
def nested_sum(lista_paran):
    lista = []
    for lista_ in lista_paran:
...
print(";".join(lista_cadastro))
print(';'.join(lista_cadastrados))
print(';'.join(lista_cadastrados1))
...
lista_aninhada_2[3][2][1].append("Nao pode ter o 10")
