...
print(f'{lista[1][1:2]} {lista[1][5:6]}')
...
print(f'{lista[2]}: {lista[2][1]}, {lista[2][0]}, {lista[2][4:5]}')
...
print(f'3kg de {lista[1][2]}, 8kg de {lista[1][3]}, 4.5kg de {lista[1][5]}, 1kg de {lista[1][-1]}')
...
print(f'{lista[1]}: 5 maço de {lista[2][-1]}, 4 pés de {lista[2][0]} e {lista[2][1]}')

print('9: imprima com f-string a seguinte sequência: legumes: 1kg de feijão, 2kg de gão de bico, 1.5 kg dde soja,'
      '1 pacote de ervilha')
print(f'{lista[2]}: 1kg de {lista[2][0]}, 2kg de {lista[2][-2]},  1.5kg de {lista[2][-1]}, 1 pacote de {lista[2][1]}')
